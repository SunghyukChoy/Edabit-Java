...
public class DashedTests {
  @Test
  public void test1() {
    assertEquals(Program.dashed("Edabit"), "-E-d-a-b-i-t");
  }

  @Test
  public void test2() {
    assertEquals(Program.dashed("Carpe Diem"), "C-a-rp-e- D-i--e-m");
  }

  @Test
  public void test3() {
    assertEquals(Program.dashed("Fight for your right to party!"), "F-i-ght f-o-r y-o--u-r r-i-ght t-o- p-a-rty!");
  }

  @Test
  public void test4() {
    assertEquals(Program.dashed(
  ...
  @Test
  public void test5() {
    assertEquals(Program.dashed("Fear the soldier who stammers, for he is very fast at pulling the triger."),
